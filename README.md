### Welcome to TRACE (Triggered Radiotherapy Adaptive Control Engine)! 
This software accompanies the dynamic anthropomorphic thorax phantom, as described in Lustermans et al. (2024).

# Features
### Phantom input generations
- Create analytical curves
- Edit patient-derived curves
